...
<body class="bg-gray-900 text-gray-100 font-sans scroll-smooth scroll-pt-20">
    ...
    <header x-data="{ open: false }"
        ...
        <nav class="max-w-6xl mx-auto flex items-center justify-between py-4 px-6">
            ...
            <div>
                {{-- [PERUBAHAN WARNA] --}}
                <a href="#hero" class="text-xl font-bold text-white hover:text-orange-400 transition-colors duration-300">
        ...
        <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
            ...
            style="display: none;" untuk mencegah "flash" saat load --}}
            ...
            <ul class="flex flex-col items-center py-4">
                ...
                <li>
                    ...
                    <a href="#about" @click="open = false"
                        class="block py-3 px-6 text-gray-300 hover:text-orange-400 transition-colors duration-300">
                        Tentang Saya
                    </a>
                </li>
                <li>
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="#pendidikan" @click="open = false"
                        class="block py-3 px-6 text-gray-300 hover:text-orange-400 transition-colors duration-300">
                        Pendidikan
                    </a>
                </li>
                <li>
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="#pengalaman" @click="open = false"
                        class="block py-3 px-6 text-gray-300 hover:text-orange-400 transition-colors duration-300">
                        Pengalaman
                    </a>
                </li>
                <li>
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="#keahlian" @click="open = false"
                        class="block py-3 px-6 text-gray-300 hover:text-orange-400 transition-colors duration-300">
                        Keahlian
                    </a>
                </li>
                    ...
                    <div class="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-orange-400/50 hover:bg-white/10 transition-all duration-300 shadow-lg"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <img @if($s->foto_skill)
                                ...
                                @else src="{{ asset('images/Foto-profil.png') }}" @endif alt="{{ $s->nama_skill }}"
                                class="w-16 h-16 rounded-xl object-cover flex-shrink-0 border border-white/10">

                            {{-- === [TWEAK DESAIN: BADGE KEAHLIAN] === --}}
                            <div class="text-left">
                                <h3 class="text-xl font-semibold text-white mb-2">{{ $s->nama_skill }}</h3>
                                {{-- [PERUBAHAN WARNA] --}}
                                <span class="px-2.5 py-0.5 bg-orange-900/50 text-orange-300 text-xs font-semibold rounded-full">
                                    {{ $s->tingkat }}
                                </span>
                            </div>
                                ...
                                <a href="{{ $linkUrl }}" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <div class="p-6 text-left">
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            {{-- [PERUBAHAN WARNA] --}}
                                            <span
                                                class="text-orange-400 text-sm flex-shrink-0 ml-2">{{ $prt->tahun ?? '-' }}</span>
                                        </div>
                                        @if($prt->posisi)
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div
                ...
                <div class="flex justify-center md:justify-end space-x-6">
                    ...
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="https://linkedin.com/in/hikarinaufal" class="text-gray-400 hover:text-orange-400 transition"
                        aria-label="LinkedIn">
                    ...
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="https://github.com/Kariispyc" class="text-gray-400 hover:text-orange-400 transition"
                        aria-label="GitHub">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
                    ...
                    {{-- [PERUBAHAN WARNA] --}}
                    <a href="https://www.instagram.com/varaxess/" class="text-gray-400 hover:text-orange-400 transition"
