    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-8 md:space-y-0">
            ...
            <div class="flex justify-center md:justify-end space-x-6">
                ...
                <a href="#" class="text-gray-400 hover:text-cyan-400 transition" aria-label="LinkedIn">
                ...
                <a href="#" class="text-gray-400 hover:text-cyan-400 transition" aria-label="GitHub">
                 ...
                 <a href="#" class="text-gray-400 hover:text-cyan-400 transition" aria-label="Instagram">
